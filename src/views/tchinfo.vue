          ...
          <el-card>
            ...
            <el-form :model="userInfo" label-width="120px">
              <el-form-item label="姓名">
                <el-input v-model="userInfo.first_name" disabled />
              </el-form-item>
  
              <el-form-item label="工号">
                <el-input v-model="userInfo.student_number" disabled />
              </el-form-item>
  
              <el-form-item label="身份">
                <el-input v-model="userInfo.user_group" disabled />
              </el-form-item>
            </el-form>
          </el-card>
           <!-- 注销按钮 -->
    <div class="logout-button-container">
      <el-button type="danger" @click="logout" class="logout-button">退出账号</el-button>
    </div>
        </el-tab-pane>
      ...
      const fetchUserInfo = async () => {
        try {
          ...
          userInfo.value = {
            ...
            student_number: response.username,
