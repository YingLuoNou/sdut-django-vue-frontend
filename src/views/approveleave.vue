        ...
        <el-tabs v-model="activeTab" @tab-click="handleTabClick">
            ...
            <el-tab-pane label="待审批" name="0">
                ...
                >
                    ...
                    <el-table-column
                        label="请假时间"
                        :formatter="(row) => formatDate(row.leave_time)"
                        width="180"
                    ></el-table-column>
    ...
    setup() {
        ...
        const approveLeave = async (leaveId) => {
            ...
            try {
                ...
                await request.patch(`/admin/approve-leave/${leaveId}/`, {
                    status: 1
                })
        ...
        const pre_approveLeave = async (leaveId) => {
            ...
            try {
                isApproving[leaveId] = true
                await request.patch(`/pre_approve_leave/${leaveId}/`, {
                    status: 5
                })
                await fetchLeaveRequests() // 刷新列表
        ...
        const completeLeave = async (leaveId) => {
            ...
            try {
                ...
                await request.patch(`/CompleteLeavingView/${leaveId}/`, {
                    status: 3
                }) // 假设状态3代表已销假
                await fetchLeaveRequests() // 刷新列表
